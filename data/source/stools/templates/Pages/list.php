<ul uk-accordion="multiple: true">
    <li class="uk-open">
        <a class="uk-accordion-title" href="#">Điều kiện tìm kiếm</a>
        <div class="ui form uk-grid uk-grid-medium uk-accordion-content" data-uk-grid>
            <div class="uk-width-1-1@s uk-width-1-2@m uk-width-1-4@l uk-width-1-5@xl">
                <label>Name</label>
            ...
            <div class="uk-width-1-1@s uk-width-1-2@m uk-width-1-4@l uk-width-1-5@xl">
                <label class="uk-visible@m">&nbsp;</label>
                <div class="uk-form-controls">
                    <input type="text" placeholder="Last Name">
                </div>
            </div>
            <div class="uk-width-1-1@s uk-width-1-2@m uk-width-1-4@l uk-width-2-5@xl">
    ...
    <li>
        <a class="uk-accordion-title" href="#">Danh sách dữ liệu</a>
                ...
                <table class="uk-table uk-table-hover uk-table-middle uk-table-divider">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><img class="uk-preserve-width uk-border-circle" src="/img/avatar.svg" width="40" alt=""></td>
