 ...
 */
namespace App\Controller\Api\TimeSheet;
    ...
    public function getList(): Response
    {
        ...
        try {
            $payload = array(
                0 => json_decode('{
                    "id": 1,
                    "name": "Timesheet example 1",
                    "desc": "Desc excemple 1"
                }'),
                1 => json_decode('{
                    "id": 1,
                    "name": "Timesheet example 2",
                    "desc": "Desc excemple 3"
                }'),
                2 => json_decode('{
                    "id": 1,
                    "name": "Timesheet example 3",
                    "desc": "Desc excemple 3"
                }'),
                3 => json_decode('{
                    "id": 1,
                    "name": "Timesheet example 4",
                    "desc": "Desc excemple 4"
                }'),
                4 => json_decode('{
                    "id": 1,
                    "name": "Timesheet example 5",
